...
CREATE TABLE IF NOT EXISTS `mydb`.`contratista` (
  ...
  INDEX `fk_CONTRATISTA_PERSONA1` (`idPersona` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`contratistas_en_contratos` (
  ...
  `idContrato` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_CONTRATISTAS_en_CONTRATOS_CONTRATISTA1` (`idContratista` ASC) VISIBLE,
  INDEX `fk_CONTRATISTAS_en_CONTRATOS_CONTRATO1` (`idContrato` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`productos_en_contratos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_PRODUCTOS_EN_CONTRATOS_CONTRATO1` (`idContrato` ASC) VISIBLE,
  INDEX `fk_PRODUCTOS_EN_CONTRATOS_PRODUCTO_SERVICIO1` (`idProducto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`seguimiento` (
  ...
  INDEX `fk_SEGUIMIENTO_CONTRATO1` (`idContrato` ASC) VISIBLE,
